...
class Priority extends AbstractCarrier implements CarrierInterface
{
     ...
     * @var string
     */
    protected $_code = 'swisspostpriority';
    /**
     * @var bool
     */
    ...
    protected function createResultMethod($shippingPrice)
    {
        ...
        $method->setCarrier('swisspostpriority');
        $method->setCarrierTitle($this->getConfigData('title'));

        $method->setMethod('swisspostpriority');
    ...
    {
        return ['swisspostpriority' => $this->getConfigData('name')];
    }
